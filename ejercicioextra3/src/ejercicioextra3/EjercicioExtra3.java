...
public class EjercicioExtra3 {
    ...
    public static void main(String[] args) {
        ...
        // 3. Ha llegado el momento de poner de prueba tus conocimientos. Para te vamos 
        // a contar que te ha contratado “La Tercera Seguros”, una empresa aseguradora 
        // que brinda a sus clientes coberturas integrales para vehículos.
        //
        ...
        // en ella son: número de póliza, fecha de inicio y fin de la póliza, cantidad de 
        // cuotas, forma de pago, monto total asegurado, incluye granizo, monto máximo granizo, 
        // tipo de cobertura (total, contra terceros, etc.). Nota: prestar atención al 
        // principio de este enunciado y pensar en las relaciones entre clases. Recuerden 
        // que pueden ser de uno a uno, de uno a muchos, de muchos a uno o de muchos a muchos.
        ...
        CuotaPolizaServicio servicio = new CuotaPolizaServicio();
        CuotaPoliza cuotaPoliza = servicio.crearCuotaPoliza();
